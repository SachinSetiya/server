...
public:
  ...
  store_key(THD *thd, Field *field_arg, uchar *ptr, uchar *null, uint length,
    ...
    :null_key(0), hash_key(is_hash_key_part), null_ptr(null), err(0)
  {
 ...
 public:
  store_key_field(THD *thd, Field *to_field_arg, uchar *ptr,
    ...
    :store_key(thd, to_field_arg,ptr,
         ...
         : (uchar*) 0, length, is_hash_key_part), field_name(name_arg)
  {
    if (to_field)
    {
...
public:
  store_key_item(THD *thd, Field *to_field_arg, uchar *ptr,
    ...
    :store_key(thd, to_field_arg, ptr,
         ...
         &err : (uchar*) 0, length, is_hash_key_part), item(item_arg), use_value(val)
  {}
...
public:
  store_key_const_item(THD *thd, Field *to_field_arg, uchar *ptr,
           ...
           Item *item_arg,bool is_hash_key_part= false)
    :store_key_item(thd, to_field_arg, ptr,
		    null_ptr_arg ? null_ptr_arg : item_arg->maybe_null ?
        &err : (uchar*) 0, length, item_arg, FALSE, is_hash_key_part), inited(0)
  {
  }
